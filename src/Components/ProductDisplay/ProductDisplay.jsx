      ...
      <div className="productdisplay-right">
        ...
        <div className="productdisplay-right-prices">
          ...
          <div className="productdisplay-right-description">
            ...
            excepturi amet quisquam. Voluptas et at obcaecati ratione mollitia!
            Consectetur, non. Ab illo similique id voluptatum cupiditate. Rem
            explicabo quisquam odit.
          </div>
